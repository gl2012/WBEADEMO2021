...
--%>
<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<WBEADMS.Models.ShippingCompany>>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2 class="title-icon icon-labs">Shipping Companies</h2>
	<p class="noPrint">Would you like to <strong><%= Html.ActionButton("Create a New Shipping Company", "Create")%></strong>?</p>
