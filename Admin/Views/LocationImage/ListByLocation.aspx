...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            ...
            <td>
                <%= HtmlHelperExtensions.ToStringOrDefaultTo(item.DateUploaded, "unknown", WBEADMS.ViewsCommon.FetchDateFormat(false) + " " + WBEADMS.ViewsCommon.FetchTimeFormat())%>                
            </td>
            <td>
                <%= HtmlHelperExtensions.ToStringOrDefaultTo(item.ModifiedBy, "")%>
            </td>
            <td>
                <%= HtmlHelperExtensions.ToStringOrDefaultTo(item.DateModified, "", WBEADMS.ViewsCommon.FetchDateFormat(false) + " " + WBEADMS.ViewsCommon.FetchTimeFormat())%>                
            </td>
            <td>
