...
function deleteCOCExport(id) {
    $.ajax({
        url: "/Home.aspx/RemoveExportCOC/"+id,
        success: function (result) {
            if ($('#CoCExportSpan').length) {
                $('#CoCExportSpan').html(result);
            }
        }
    });
}
function deleteBatchCOCExport(id) {
    $.ajax({
        url: "/Home.aspx/RemoveExportBatchCOC/" + id,
        success: function (result) {
            if ($('#CoCExportSpan').length) {
                $('#CoCExportSpan').html(result);
            }
...
function addCOCExport(id) {
    $.ajax({
        url: "/Home.aspx/AddExportCOC/"+id,
        success: function (result) {
            if ($('#CoCExportSpan').length) {
                $('#CoCExportSpan').html(result);
            }
...
function addBatchCOCExport(id) {
    $.ajax({
        url: "/Home.aspx/AddExportBatchCOC/" + id,
        success: function (result) {
            if ($('#CoCExportSpan').length) {
                $('#CoCExportSpan').html(result);
            }
