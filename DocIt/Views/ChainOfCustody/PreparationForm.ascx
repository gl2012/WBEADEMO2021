    ...
    <fieldset>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="cocTable">
            ...
            <tr>
                ...
                <td>
                    <%= HtmlHelperExtensions.ToStringOrDefaultTo(Model.Schedule, "None") %>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <%= Html.DatePicker("date_sampling_scheduled", preparation.date_sampling_scheduled.ToDateFormat())%>
                    <%= Html.ValidationMessage("date_sampling_scheduled", "*")%>
                </td>
            </tr>
        </table>
        <input type="hidden" name="section" value="Prepare" />
		</div>
    </fieldset>